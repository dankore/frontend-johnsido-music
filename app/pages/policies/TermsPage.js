...
function TermsPage() {
  ...
  return (
    <PolicyTemplate
      pageTitle="Terms"
      policyType="Johnsido Terms & Conditions"
      svg={
        <svg
    ...
    >
      <p>
        This website is operated by Johnsido. Throughout the site, the terms “we”, “I”, “us”, “our”,
        and “Website” refer to Johnsido. Johnsido offers this website, including all information,
      ...
      <p className="mt-4">
        By visiting our site and/or purchasing something from us and other users, you engage in our
        “Service” and agree to be bound by the following terms and conditions (“Terms of Service”,
        “Terms”), including those additional terms and conditions and policies referenced herein and
        / or available by hyperlink. These Terms of Service apply to all users of the site,
      ...
      <p className="mt-4">
        <b>LICENSE:</b> In these Website Standard Terms And Conditions, “Your Content” shall mean
        any audio, video, text, images or other material you choose to display on this Website. With
        respect to Your Content, by displaying it, you grant Johnsido a non-exclusive, worldwide,
        irrevocable, royalty-free, sub licensable license to use, reproduce, adapt, publish,
        translate and distribute it in any and all media. Your Content must be your own and must not
        be infringing on any third party’s rights. Johnsido reserves the right to remove any of Your
        Content from this Website at any time, and for any reason, without notice.
      </p>
      <p className="mt-4">
        <b>NO WARRANTIES:</b> This Website is provided “as is,” with all faults, and Johnsido makes
        no express or implied representations or warranties, of any kind related to this Website or
      ...
      <p className="mt-4">
        ...
        maturity in your state or province of residence, and you have given us your consent to allow
        any of your minor dependents to use this site. If you are under the age of eighteen (18),
        you represent that a parent or legal guardian also agrees to this section on your behalf.
        ...
        laws). You must not transmit any worms or viruses or any code of a destructive nature. A
      ...
      <p className="mt-4">
        ...
        that your content(not including credit card information), may be transferred un-encrypted
      ...
      <p className="mt-4">
        ...
        parties as to the origin of any comments. You are solely responsible for any comments you
        make and their accuracy. We take no responsibility and assume no liability for any comments
      ...
      <p className="mt-4">
        ...
        loss of data, replacement costs, or any similar damages, whether based in contract,
        tort(including negligence), strict liability or otherwise, arising from your use of any of
        the service or any products procured using the service, or for any other claim related in
        any way to your use of the service or any product, including, but not limited to, any errors
      ...
      <p className="mt-4">
        ...
        governed by and construed in accordance with the laws of Iowa, United States.
      </p>
