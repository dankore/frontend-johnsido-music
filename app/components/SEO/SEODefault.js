...
function SeoDefault() {
  ...
  const description = `I'm a gospel musician on a journey to help myself and other upcoming musicians.`;
  const title = `Listen to my songs or explore others' | Johnsido Music`;
